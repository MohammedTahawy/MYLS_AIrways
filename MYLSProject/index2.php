              ...
              <div class="about-table w-75 m-auto rounded-3 shadow">
                ...
                if(isset($_SESSION['POST_Book1'])){
                  ...
                  echo"
                    <tr>
                      <td>$x</td>
                      <td>{$_SESSION['ticks'][$i]['Travell_agency']}</td>
                      <td>{$_SESSION['ticks'][$i]['Source']}</td>
                      <td>{$_SESSION['ticks'][$i]['Destination']}</td>
                      <td>{$_SESSION['ticks'][$i]['Date']}</td>
                      <td>{$_SESSION['ticks'][$i]['Price']}</td>
                  ...
                  <a class='btn btn-danger return col-lg-2 me-4' href='mainpg.php'>Return</a>
                  <input
                    type='submit'
                    name='book2'
                    value='Next'
                ...
                <form action="./back/BOOK_Process3.php" method="post">
